describe Gravtastic do
  ...
  describe 'Gravtastic.gravatar_url' do
    ...
    it "makes a jpeggy URL" do
      Gravtastic.gravatar_url('email', :rating => 'PG', :secure => false, :filetype => :jpg).should == 'http://gravatar.com/avatar/mailhash.jpg?r=PG'
    end

    it "makes a saucy URL" do
      Gravtastic.gravatar_url('email', :rating => 'R', :secure => false, :filetype => :png).should == 'http://gravatar.com/avatar/mailhash.png?r=R'
    end

    it "abides to some new fancy feature" do
      Gravtastic.gravatar_url('email', :rating => 'PG', :secure => false, :filetype => :png, :extreme => true).should == 'http://gravatar.com/avatar/mailhash.png?extreme=true&r=PG'
    end
